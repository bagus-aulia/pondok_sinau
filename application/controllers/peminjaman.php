...
class Peminjaman extends CI_Controller {
	...
	{
	    $kd_buku = $this->input->post('kd_buku');
	    $buku = $this->m_crud->get_id('t_buku', 'kd_buku', $kd_buku);
	    ...
	    if($buku->num_rows() == 0) {
	        ...
	        if($book->status == "n"){
    	        ...
    	        $record  = array(
    					'kd_buku' => $book->kd_buku,
    					'judul' => $book->judul,
    					'pengarang' => $book->pengarang,
    				);
    
                $cek_count = $this->m_crud->get_id('temp', 'kd_buku', $book->kd_buku)->num_rows();
	...
	public function tambahBuku()
	{
        ...
        $cek_count = $this->m_crud->get_id('temp', 'kd_buku', $this->input->post('kd_buku'))->num_rows();
