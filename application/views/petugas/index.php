	...
	<div class="panel panel-info">
		<div class="panel-body">
			<div class="well well-sm">
				<a href="<?php echo site_url('pustakawan/tambah') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
			</div>
			<div class="table-responsive">
				<div class="panel panel-warning">
					<div class="panel-body">
						<!--<form action="<?php echo site_url('pustakawan/cariData') ?>" method="post">	-->
							...
							<tbody>
								<?php $no=1; foreach ($petugas as $p): ?>
									<tr>
										...
										<td>
											<?php echo $p->nama ?><br>
											<a href="<?php echo site_url('pustakawan/edit/'.$p->id_user) ?>">Edit</a>&nbsp;|&nbsp;
...
<script>
	$(function(){
		...
		$('.reset_pass').click(function(){
			...
			$.ajax({
				url  : "<?php echo site_url('pustakawan/resetPassword') ?>",
				type : "POST",
