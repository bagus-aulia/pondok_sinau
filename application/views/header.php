<nav class="navbar navbar-default" role="navigation">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="<?php echo base_url() ?>">Lentera Anak Nusantara</a>
	</div>
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		...
		<?php  
			...
			{
				$masteradmin = array('buku', 'anggota', 'pustakawan');
					...
					?>
						<li class="dropdown">
							...
							for ($i=0; $i < count($masteradmin); $i++) { 
								echo '<li><a href="'.base_url($masteradmin[$i]).'">'.ucwords($masteradmin[$i]).'</a></li>';
							}
							?>
							</ul>
						</li>
						<li class="dropdown">
							...
							for ($i=0; $i < count($transaksi); $i++) { 
								echo '<li><a href="'.base_url($transaksi[$i]).'">'.ucwords($transaksi[$i]).'</a></li>';
							}
							?>	
							</ul>
						</li>
						<li class="dropdown">
							...
							for ($i=0; $i < count($laporan); $i++) { 
								echo '<li><a href="'.base_url('lap_'.$laporan[$i]).'">'.ucwords($laporan[$i]).'</a></li>';
							}
							?>	
							</ul>
						</li>
					...
					?>
						<li class="dropdown">
							...
							for ($i=0; $i < count($masterpetugas); $i++) { 
								echo '<li><a href="'.base_url($masterpetugas[$i]).'">'.ucwords($masterpetugas[$i]).'</a></li>';
							}
							?>
							</ul>
						</li>
			...
			if ($this->session->userdata('islogin') == true) {
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo base_url('dashboard/gantipassword') ?>"><i class="fa fa-key"></i> Ganti Password</a></li>
