    ...
    function setEventListeners() {
        video.addEventListener('canplay', function(e) {
            if (!isStreaming) {
                ...
                display.setAttribute('width', 250);
                display.setAttribute('height', 250);
                isStreaming = true;
        ...
        video.addEventListener('play', function() {
            setInterval(function() {
                if (!video.paused && !video.ended) {
                    ...
                    var imageData = con.getImageData(0, 0, 250, 250);
                    ...
                    if (options.codeRepetition || lastCode != a) {
                        ...
                        $.ajax({
    						...
    						success : function(msg){
								if (msg == "") {
						            swal("Info", "Buku tidak ada dalam transaksi peminjaman", "error");
                					$("#tampil_data").html("");
                				}
                				else
                				{
